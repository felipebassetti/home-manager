...
Estas historias de usuario sao os cards que vao guiar desenvolvimento, validacao manual e futuras automacoes de teste do Republic House.
...
| HU-007 | Lancar cobranca mensal para a casa | admin da casa | planned | P1 |
| HU-008 | Gerenciar moradores da casa | admin da casa | planned | P1 |
| HU-009 | Entrar com autenticacao real do Supabase | admin e morador | planned | P1 |
